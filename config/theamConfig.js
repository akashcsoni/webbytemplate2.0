...
// TEMPORARY: Set to false when Earnings module should be visible again
const HIDE_EARNINGS_TEMPORARILY = true;
...
export { URL, SITE_URL, STRAPI_URL, themeConfig, NO_AVTAR_IMAGE, NO_FOUND_PRODUCT_GRID_IMAGE, TRACKING_API_URL, IP_API_URL, HIDE_EARNINGS_TEMPORARILY };