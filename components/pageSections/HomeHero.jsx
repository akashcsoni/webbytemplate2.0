...
export default function HomeHero({
  ...
  // If skipHeading is true, only render interactive parts (search, tags)
  // The h1 is already rendered server-side for LCP optimization
  if (skipHeading) {
    return (
  ...
  // Full component with heading (for non-home pages or when not server-rendered)
  return (
    <section className="xl:pb-[35px] lg:pb-[30px] pb-[25px] 2xl:pt-20 1xl:pt-16 lg:pt-14 sm:pt-10 pt-8">
      <div className="container mx-auto">
        <div className={`flex flex-col items-${alignment} text-${alignment}`}>
          ...
          {/* Subheading */}
          {
            (with_description || with_description == null) && (
