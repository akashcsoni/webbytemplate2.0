  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        ...
        // Apply base only for category context
        if (selectedCategory) {
          payload.base = selectedCategory;
        } else if (base === "category" && currentSlug) {
          payload.base = currentSlug;
        }
    ...
    fetchProductData();
  }, [filter, page_size, selectedCategory, category, currentSlug, base]);
