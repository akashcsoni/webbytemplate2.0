    ...
    const fetchSupportData = async (id, position) => {
      ...
      try {
        ...
        const supportData = await strapiPost(
          `supports/${position}/${id}`,
          payload,
          themeConfig.TOKEN
        );

        // console.log(supportData.data);
        ...
        if (supportData?.data) {
          const formattedData = supportData.data.map((item) => {
            ...
            return {
              ...
              status: lastComment?.note_status,
            };
          });
                      ...
                      >
                        <div>
                          <Input
                            ...
                            defaultValue={filterData?.ticket_number || ""}
                        ...
                        <div>
                          <Input
                            ...
                            defaultValue={filterData?.product_name || ""}
                            onChange={handleInputChange}
                            label="Product Name"
                            labelPlacement="outside"
                            placeholder="Enter product name"
