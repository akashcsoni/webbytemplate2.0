  ...
  const renderComponent = (component, index) => {
    ...
    switch (__component) {
      ...
      case "shared.single-blog-image":
        return (
          <SingleBlogImageComponentServer
...
// Rich Text Component Server
const RichTextComponentServer = ({ data }) => {
...
export default BlogComponentsRendererServer;
