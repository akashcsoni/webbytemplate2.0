                  ...
                  <div className="flex items-center gap-2">
                    {pageData.author.image?.url ? (
                      <div className="relative w-7 h-7 overflow-hidden rounded-full">
                        <Image
                          src={
                            `${pageData.author.image.url}` || "/placeholder.svg"
                          }
                          alt={`${pageData.author.full_name}'s profile picture`}
                          fill
                          sizes="28px"
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-full">
                        <button className="btn btn-secondary flex items-center justify-center w-full">
                          ...
                          >
                            <path
                              d="M1.88316 9.34326C0.00754266 6.84243 0.632748 3.0912 3.75878 1.84079C6.8848 0.590379 8.76042 3.0912 9.38563 4.34161C10.0108 3.0912 12.5117 0.590379 15.6377 1.84079C18.7637 3.0912 18.7637 6.84243 16.8881 9.34326C15.0125 11.8441 9.38563 16.8457 9.38563 16.8457C9.38563 16.8457 3.75878 11.8441 1.88316 9.34326Z"
                              stroke="#0156D5"
                              strokeWidth="1.43214"
                              strokeLinecap="round"
                              strokeLinejoin="round"
