      ...
      <div className="bg-white xl:border-b border-primary/10">
        <div className="flex items-center h-[75px] mx px-4 sm:flex-nowrap flex-wrap w-full">
          ...
          <div className="button-content lg:space-x-1 sm:space-x-2 space-x-1 nav-icons flex-1 w-[50%] 1xl:justify-start justify-end">
                  ...
                  <button onClick={() => logout()} className="login">
                    ...
                    {isHeaderLoading ? (
                      ...
                      <svg
                        ...
                        viewBox="0 0 20 20"
                        fill="none"
                        className="sm:w-[22px] sm:h-[22px] w-4 h-4 1xl:hidden block"
                      >
                        <path
            ...
            {/* after login */}
            <div className="hidden <flex> items-center justify-center 1xl:gap-[15px] sm:gap-2 1xl:border-l border-gray-100">
              <div className="relative flex text-left" ref={dropdownRef}>
                {isHeaderLoading ? (
                  <Skeleton className="rounded-md schedule-skeleton 1xl:h-[40px] h-6" />
                ) : (
                  <button
                    onClick={toggleDropdown}
                    className="inline-flex items-center 1xl:gap-2 btn btn-primary focus:outline-none"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      ...
                      viewBox="0 0 20 21"
                      fill="none"
                      className="2xl:w-[22px] 2xl:h-[22px] w-[18px] h-[18px] icon"
                    >
                      <path
                        d="M9.9998 8.91758C11.91 8.91758 13.4586 7.36902 13.4586 5.45879C13.4586 3.54855 11.91 2 9.9998 2C8.08957 2 6.54102 3.54855 6.54102 5.45879C6.54102 7.36902 8.08957 8.91758 9.9998 8.91758Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                      <path
                        d="M16.5358 15.4749C16.5358 17.5044 16.5358 19.15 10.0023 19.15C3.46875 19.15 3.46875 17.5044 3.46875 15.4749C3.46875 13.4454 6.39413 11.7998 10.0023 11.7998C13.6104 11.7998 16.5358 13.4454 16.5358 15.4749Z"
                        stroke="currentColor"
                        strokeWidth="1.5"
                      />
                    </svg>
                ...
                {open && (
                  <div
                    className="absolute top-[52px] right-0 bg-white border border-primary/10 before:border-primary/10 before:border shadow-dropDown before:z-0 rounded-md z-10
