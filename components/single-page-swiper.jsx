  ...
  const socialButtons = [
    {
      ...
      url: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${text} ${productUrl} Try out`)}`,
    },
    {
      name: "Twitter",
      icon: (
      ...
      url: `https://twitter.com/intent/tweet?text=${encodeURIComponent(`${text} ${productUrl} Try out`)}`,
    },
    {
      name: "Pinterest",
      icon: (
      ...
      url: `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(productUrl)}&media=${encodeURIComponent(pageData?.grid_image ?? "")}&description=${encodeURIComponent(pageData?.title ?? "")}`,
    },
    {
      name: "YouTube",
      icon: (
      ...
      url: `https://www.youtube.com/watch?v=${encodeURIComponent(productUrl)}`,
    },
    {
      name: "Instagram",
      icon: (
      ...
      url: `https://www.instagram.com/watch?v=${encodeURIComponent(productUrl)}`,
    },
    {
      name: "LinkedIn",
      icon: (
