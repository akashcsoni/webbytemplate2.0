  ...
  return (
    <div className="relative w-full mb-5 ">
     <div className="2xl:w-[59vw] lg:w-[68vw] w-[98vw] [@media(max-width:350px)]:w-full">
      ...
      <div className="flex sm:justify-between justify-cenetre items-center sm:flex-row flex-col-reverse w-full sm:mt-[25px] mt-5 gap-5">
        <div className="flex sm:justify-start justify-center items-center w-full gap-[10px]">
          <div className="border border-blue-300 p-3 rounded-full xl:w-11 xl:h-11 w-10 h-10 hover:border-primary hover:bg-primary group flex items-center justify-center">
            <svg
