...
export async function AuthorFooterContainer() {
    try {
        ...
        return <AuthorFooter footerMenu={menuData} footerSettings={settingsData} />
    } catch (error) {
        console.error("Error in AuthorFooter component:", error)
        // Return the client component with fallback data
        return <AuthorFooter footerMenu={fallbackMenuData.data.menu} footerSettings={fallbackSettingsData.data[0]} />
    }
}
