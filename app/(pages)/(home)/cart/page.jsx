...
const originalItem = {
  id: 1,
  licensePrice: 129,
  img: "/images/cart-orion.png",
  title: "Orion: Construction Company Figma UI Template Kit",
  license: "Commercial license",
  price: 129.0,
  addOns: [
    { name: "Get 6 more months of support and save $19", price: 20.0 },
    { name: "Installation & Setup", price: 49.0 },
    { name: "Installation & Customization Package", price: 209.0 },
    { name: "All-in-One Customization - SEO", price: 119.0 },
    { name: "Must-Have Plugins", price: 39.0 },
    { name: "GDPR & CCPA Compliance - New Privacy Rules", price: 59.0 },
  ],
};
                ...
                <div className="flex items-start sm:flex-row flex-col xl:gap-[30px] sm:gap-5 gap-4">
                  ...
                  <div className="flex-1 sm:w-auto w-full">
                    <div className="flex justify-between items-start sm:flex-nowrap flex-wrap">
                      ...
                      <button className="mt-1 !text-primary hover:!text-gray-200 2xl:text-base xl:text-[15px] text-sm flex items-center gap-2 group flex-shrink-0">
                        Remove item
                        <svg
                    ...
                    <div className="flex items-cener justify-between w-full sm:flex-nowrap flex-wrap sm:gap-0 gap-y-1">
                      <p className="2xl:text-base xl:text-[15px] text-sm text-gray-500 sm:mt-1 mt-0.5">
                        License type:{" "}
                        <span className=" text-primary">{item.license}</span>
                      </p>
                      <p className="!text-black font-medium">
                        ${item.licensePrice}.00
                      </p>
                    </div>
          ...
          <div className="w-full lg:w-[31%] h-fit sm:pt-[30px] pt-5 divide-y divide-primary/10 2xl:space-y-6 1xl:space-y-5 xl:space-y-4 space-y-3">
            ...
            <div>
              <div className="1xl:pt-[18px] xl:pt-4 pt-3 flex justify-between text-base font-medium 1xl:mb-[18px] xl:mb-4 mb-3.5">
                ...
                <p className="font-medium !text-black">$1704.00</p>
              </div>
              <Button className="w-full btn btn-primary 2xl:!py-3 1xl:!py-2.5 !py-[9px] h-auto">
                Process to Checkout
              </Button>
            </div>
          </div>
