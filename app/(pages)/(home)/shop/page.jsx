    ...
    <div className="container px-4 py-8">
      <div className="flex flex-col xl:flex-row xl:gap-[34px]">
          ...
          >
            ...
            <div className="xl:space-y-[30px] space-y-7">
              <DropdownSection title="Categories">
                <ul className="text-sm 1xl:space-y-[14px] space-y-3">
                  {[
        ...
        <main className="w-full xl:w-4/5">
          <nav className="flex items-center text-sm xl:mb-[14px] mb-3">
          ...
          {/* Grid */}
          <div className="">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6"></div>
          </div>
