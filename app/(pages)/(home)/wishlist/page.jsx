...
const wishlistItems = [
  {
    ...
    name: "Orion: Construction Company Figma UI Template Kit",
    price: "$29.00",
  },
  {
    id: 2,
  ...
  return (
    <div className="py-8">
      <div className="container">
        <div className="flex justify-between items-center border-b border-primary/10 pb-[25px] mb-[25px]">
          <div>
            <h1 className="h2 mb-[2px]">My Wishlist</h1>
            <p className="p2">4 items in Wishlist</p>
          </div>
          <div className="flex items-center">
            <div className="flex gap-4">
              <button className="btn btn-outline-primary gap-[10px] font-medium">
                <svg
              ...
              <button className="btn btn-primary gap-[10px] font-medium">
        ...
        <table className="w-full">
          <thead className="bg-blue-100 p2 text-black">
            <tr>
              <th className="py-3 px-4 text-start rounded-l-[4px] w-[150px]">
                Image
              </th>
              <th className="py-3 px-4 text-start w-[650px]">Product name</th>
              <th className="py-3 px-4 text-start w-[250px]">Price</th>
              <th className="py-3 px-4 text-start w-[250px]">Add to cart</th>
              <th className="py-3 px-4 text-start  rounded-r-[4px]">Remove</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-800">
            {wishlistItems.map((item) => (
              <tr key={item.id} className="">
                ...
                <td className="py-4 px-4 p font-medium !text-black">
                  {item.name}
                </td>
                <td className="py-4 px-4">{item.price}</td>
                <td className="py-4 px-4">
                  <button className="text-blue-500 hover:border-primary border-b border-white flex items-center gap-1">
                    Add to cart{" "}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="15"
