      ...
      {step === 1 && (
        <div className="md:space-y-[25px] space-y-5">
          ...
          <p className="2xl:text-base md:text-[15px] sm:text-sm text-[13px] font-light md:px-[30px] px-5 text-[#808080] md:leading-[26px] leading-[23px]">
            At DailyWe, we value your privacy and are committed to protecting
            your personal information. By using our website or app, you agree to
            our Privacy Policy and Terms of Use. We may collect and use your
            data to improve our services. Please review our policy regularly for
            updates. For any queries, reach out to us at{" "}
        ...
        <div className="md:space-y-6 space-y-5">
          ...
          <div className="px-[20px] space-y-5">
            <p className="text-[#616161] 2xl:text-base md:text-[15px] text-sm font-light md:mb-[25px] mb-5">
              Have any thoughts to share? We`&lsquo;d love your feedback!
              (optional)
            </p>
            ...
            <div className="flex justify-between items-center">
              <p className="sm:text-sm text-[13px] font-light text-[#616161] leading-[22px]">
                <span className="font-normal text-black">Note:</span> All your
                account data will be permanently deleted as per our privacy
                policy. Once deleted, this information cannot be recovered.
              </p>
            </div>
          </div>
        </div>
