...
export default function DashboardPage() {
  ...
  // table
  const columns = [
    { title: "No.", field: "no", width: 20, hozAlign: "center", responsive: 1 },
    {
      title: "Product Name",
      field: "product",
    ...
    { title: "Buyer Name", field: "buyer", hozAlign: "center", responsive: 3 },
    { title: "License Type", field: "license", responsive: 4 },
    {
      title: "Price",
      field: "price",
    ...
    { title: "Date Sold", field: "date", hozAlign: "center", responsive: 6 },
    {
      title: "Status",
      field: "status",
    ...
    { title: "Earnings", field: "earnings", hozAlign: "center", responsive: 8 },
  ];
  // table data
                ...
                <CardBody className="p-0 ">
                  <div>
                    ...
                    <div className="my-[20px] border border-primary/10 rounded-md overflow-hidden">
                      ...
                      <div className="bg-white rounded-md shadow overflow-x-auto p-5 ">
                        <ReactTabulator
