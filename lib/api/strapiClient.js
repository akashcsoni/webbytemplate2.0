...
let STRAPIURL = process.env.NEXT_PUBLIC_STRAPI_URL || STRAPI_URL;

// ✅ 2.1. Ensure the URL includes /api prefix
if (STRAPIURL && !STRAPIURL.includes('/api')) {
    STRAPIURL = STRAPIURL.replace(/\/$/, '') + '/api';
}
