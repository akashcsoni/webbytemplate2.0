...
export function isValidSlug(slug) {
    ...
    // Reject numeric-only slugs (like "9", "13", "123") to prevent random URLs from being indexed
    // This prevents URLs like /9/13/ from being generated and indexed
    if (/^[0-9]+$/.test(normalizedSlug)) {
        return false;
    }
